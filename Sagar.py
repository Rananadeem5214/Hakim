...
██████╔╝██║░░██║╚██████╔╝██║░░██║██║░░██║
╚═════╝░╚═╝░░╚═╝░╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝
\033[1;96m           [\033[1;97mOwner Brand: Hakim Sagar Sindhi \033[1;97m]    
"""
...
os.system("clear")
print  """
\033[1;95m[Owner    Hakim Sagar Sindhi]
\033[1;95m[whatsap   03072878748        ]
\033[1;91m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️
...
def login1():
	...
	try:
		...
		jalan(' \033[1;91mWarning: \033[1;92mDon,t Use any illegal activity ' )
		jalan(' \033[1;91mWarning: \033[1;92mAm Not Responsible your illegal activity ' )
		
		print('\033[1;97m\x1b[1;93m◁━━━━◈Apna Facebook Account Login karein◈━━━━▷\x1b[1;97m' )
		print('	' )
...
def menu():
	...
	print logo
	print "  \033[1;92m\033[1;93m◁━━━━◈Login Info◈━━━━▷\033[1;92m"
	print "	   \033[1;91m Name\033[1;93m:\033[1;91m"+nama+"\033[1;93m               "
	print "	   \033[1;91m ID\033[1;93m:\033[1;91m"+id+"\x1b[1;93m              "
	print "\033[1;97m[1]\x1b[1;92mStart Cloning With Sagar Tools"
	print "\033[1;97m[2]\x1b[1;92mContact me on My official Fb Account"
	print "\033[1;97m[3]\x1b[1;92mJOIN WHATSAPP 03072878748 "
	print "\033[1;97m[4]\x1b[1;92mContact With Hakim Sagar On Fb"
	print "\033[1;97m[5]\x1b[1;96mWellcome To Owner Hakim SagarAccount " 
	print "\033[1;97m[0]\033[1;96mExit            "
	pilih()
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://www.facebook.com/Hakimsagarsidhi28')
	        menu()
	elif unikers =="3":
		os.system('xdg-open https://chat.whatsapp.com/GWTPaJVAy1gDHIDgHEw0Ht')
	        menu()
        elif unikers =="4":
		os.system('xdg-open https://www.facebook.com/Hakimsagarsindhi28')
	        menu()
	elif unikers =="5":
		os.system('xdg-open https://gitub.com/Rananadeem1214')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://github.com/Rananadeem5214')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;97m[1]\x1b[1;96mClone From Friend List{Rana}"
	print "\033[1;97m[2]\x1b[1;96mClone From Public Accounts[Nadeem]"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️\033[1;91mHakim_Sagar_Sindhi\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️"
		print logo
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;93m◁━━━━◈Start Hacking Mr Hakim◈━━━━▷\033[1;93m"+o),;sys.stdout.flush();time.sleep(0.05)
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;91m+\x1b[1;92m[Rana_Hacked]'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m+\x1b[1;96m[Rana_CP]'
...
#Dev:Babar_Ali
        print "\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️\033[1;91mHakim_Sagar_Sindhi\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️"
	print '\033[1;94m♦️ Hacking Complete With Hakim Sagar Sindhi ♦️'
	print"\033[1;94mTotal\033[1;92mOK/\x1b[1;91mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;91m"+str(len(cekpoint))
	print "\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️\033[1;91mBranded_Sindhi\033[1;95m♦️🎇⚏⚏⚏🎡⚏⚏⚏🎇♦️"
	print """
...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═╝░░░░░╚═╝
"""
	print "\033[1;95m◁━━━━◈✙◈━━━━▷\033[1;91mHakim_Sagar_Sindhi\033[1;95m◁━━━━◈✙◈━━━━▷"
